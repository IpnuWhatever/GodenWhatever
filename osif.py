...
||                                                         ||
||   get_data           Data Teman			   ||
||   get_info           Lihat Informasi Tentang Teman	   ||
||							   ||
||   dump_id            fetching all id from friend list   ||
||   dump_phone         Cari Nomor Teman		   ||
||   dump_mail          Cari Email Teman		   ||
||   dump_<id>_id       Id Dari Satu Teman <spesific>      ||
||		      ex: dump_username_id		   ||
||							   ||
...
def menu_bot():
 ...
 ---------   ------------------------------------
   ...
   [ 02 ]      Bot Komen
   [ 03 ]      auto poke
   [ 04 ]      Konfirmasi Semua Teman
   [ 05 ]      Hapus Semua Status
   [ 06 ]      Hapus Semua Teman
   [ 07 ]      Berhenti Mengikuti Semua Teman
   [ 08 ]      Hapus Semua Foto 
